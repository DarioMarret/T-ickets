  ...
  confirmButtonColor: '#3085d6',
    ...
    if (result.isConfirmed) {
      if(!this.classList.contains('btn-danger') && !this.classList.contains('btn-warning') && !arrayList.includes(this.classList[0])){
        ...
        Swal.fire({title:'Desea continuar seleccionando otro asiento',
        icon: 'info',
        showDenyButton: true,
  ...
  if (result.isConfirmed) {
       ...
       if(!$("."+silla).hasClass('btn-danger') && !$("."+silla).hasClass('btn-warning') && !$("."+silla).hasClass('btn-secondary')){
        for(i=1; i<=10;i++){
          ...
          Swal.fire({title:'Desea continuar seleccionando otros asientos',
          icon: 'info',
          showDenyButton: true,
    confirmButtonText:'Continuar',
    confirmButtonColor: '#3085d6',
...
const opciones = () => {
  ...
  if ($('#chektarjeta').is(":checked")) {$('#metodo-de').text('tarjeta-credito')  
  ...
  if ($('#efectivo-tarj').is(":checked")) { $('#metodo-de').text('Efectivo')
