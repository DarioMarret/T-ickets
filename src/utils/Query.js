...
export const Authsucrito = async (parms) => {
    //console.log(parms)
    const { data } = await axios.post("https://flash.t-ickets.com/ms_login/api/v1/auth_suscriptor", parms, {
        headers: {
...
export const GenerarLinkPagoMedios = async () => {
    ...
    if (datosPersonal != null && valores != null) {
        const { data } = await axios.post("https://flash.t-ickets.com/ms_login/pago_medio", {
            datosPersonal,
            valores,
            metodo,
            concierto
...
export const GuardarDatosdelComprador = async () => {
    ...
    const { data } = await axios.post("https://flash.t-ickets.com/ms_login/api/v1/crear_suscriptor",
        datos, {
        headers: {
            'Content-Type': 'application/json',
            'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
...
export const ValidarWhatsapp = async () => {
    ...
    const { data } = await axios.post("https://flash.t-ickets.com/api_whatsapp_qr/api/validarNumero", { from: "593" + validanumero })
