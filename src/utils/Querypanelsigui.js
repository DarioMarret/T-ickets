...
export const ActualizaEstadoLocalidad = async (id, parms) => {
    const { data } = await axios.put("https://api.t-ickets.com/backend/actualizarevento_estado/" + id, parms, {
        header: {
...
export const cargarEventoActivo = async (parms) => {
    try {
        const { data } = await axios.get("https://api.t-ickets.com/backend/listareventos/" + parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const cargarMapa = async () => {
    try {
        const { data } = await axios.get("https://api.t-ickets.com/backend/listarMapas", {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const guardarMapar = async (parm) => {
    try {
        const { data } = await axios.post("https://api.t-ickets.com/backend/guardarMapa", parm, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const editarMapa = async (parm) => {
    try {
        const { data } = await axios.put("https://api.t-ickets.com/backend/actualizarMapa", parm, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const eliminaMapa = async (parm) => {
    try {
        const { data } = await axios.delete("https://api.t-ickets.com/backend/eliminarMapa/" + parm, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const enviasilla = async (info) => {
    ...
    try {
        const { data } = await axios.post("https://api.t-ickets.com/backend/api/v1/selecionar_localidad", datos, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const correlativosadd = async (parms) => {
    try {
        const { data } = await axios.post("https://api.t-ickets.com/backend/api/v1/selecionar_localidad_correlativa",
            parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
...
export const correlativodelete = async (parms) => {
    try {
        const { data } = await axios.post("https://api.t-ickets.com/backend/api/v1/selecionar_localidad_correlativa_eliminar",
            parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
...
export const listarLocalidadaEspeci = async (parms) => {
    try {
        const { data } = await axios.get("https://api.t-ickets.com/backend/api/v1/listar_localidades_id_espacio_descripcion/" + parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const guardarCarrusel = async (parms) => {
    try {
        const { data } = await axios.post("https://api.t-ickets.com/backend/api/v1/", parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const quitarsilla = async (parms) => {
    try {
        const { data } = await axios.put("https://api.t-ickets.com/backend/api/v1/quitarselecion_localidad",
            parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
...
export const buscarcliente = async (datos) => {
    try {
        const { data } = await axios.post("https://api.t-ickets.com/backend/api/v1/consultar_cedula", datos, {
            header: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const noticiasEvento = async (datos) => {
    try {
        const { data } = await axios.post("https://api.t-ickets.com/backend/api/v1/crear_evento_publicidad", datos, {
            header: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
