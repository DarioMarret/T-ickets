...
export const Emailcontec = async (parms) => {
    ...
    try {
        ...
        let config = {
            ...
            url: 'https://graph.facebook.com/v20.0/794064367126469/messages',
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Bearer EAAJoB894hLIBPYaStz3OhY40b9ZA5t1GcuPjcoQJj1gYNyftZAiIiSZA0ZCZBRAwQZB9urq1MEpc7CZBZAFgbrWAvJou2q9YYIjyLAXp3dSSKMwjolxxVyGqeXEvlH2JgtZB0KfNHUTZAcepm9wM8GCSjiidlTpbKvdLiRbHjgNZCV1KQLjrwqYIedhkI7ATlJTEz6wZCAZDZD'
            },
            data: dato
        };
