...
export const PagoRapido = async (transaccion) => {
   ...
   //  si discrimino lo tengo que guardar  let total = GetMetodo() == "Tarjeta" ? parseFloat(GetValores().total) : parseFloat(GetValores().comision) + parseFloat(GetValores().subtotal)
    ...
    try {
        ...
        const { data } = await axios.post("https://flash.t-ickets.com/ms_login/api/v1/registraCompra ", datos, {
            headers: {
 ...
 const EnviarDetalleCompra = async (email, parms) => {
    ...
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/email/api/v1/sendEmail_html", {
            "to": email,
            "html": final
        },
            {
...
export const OCRApi = async(parms)=>{
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/ocr/api/v1/ocr_space",parms)
        return data
    } catch (error) {
        return error
    }
...
export const AprobarTiket = async () => {
    try {
        let { data } = await axios.get("https://flash.t-ickets.com/ms_login/ticket_admin", {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const ConsolidaBoleto = async () => {
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/ms_login/boletos", {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const Pagofisico = async () => {
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/ms_login/pagosefectivi", {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const cederboleto = async (ceder) => {
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/ms_login//api/v1/ceder_boleto", ceder, {
...
export const GeneraToken = async (parms) => {
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/ms_login/generar_token", parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
export const ValidarToken = async (parms) => {
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/ms_login/api/v1/confirmarpago", {
...
export const generaTiketspdf = async (parms) => {
    try {
        let { data } = await axios.post("https://flash.t-ickets.com/ticket/api/v1/ticket_pdf_link", parms, {
            headers: {
                'Content-Type': 'application/json',
                'Authorization': 'Basic Ym9sZXRlcmlhOmJvbGV0ZXJpYQ=='
            }
...
//https://flash.t-ickets.com/ms_login/doc/static/index.html#/Compra/post_api_v1_liverar_asiento
//https://flash.t-ickets.com/ms_login/doc/static/index.html#/Compra/post_api_v1_generarBoleto     