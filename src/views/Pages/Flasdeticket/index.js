    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <div className="  superpuesto" id="superpuestodos">
            <div className="loader">
              ...
              >
                ...
                <g>
                  <g>
                    <path className="st0loander" fill="" d="M135.07,553.8l5.05-25.27h78.56l-5.05,25.27H135.07z M177.83,641c-8.15,0-15.1-1.65-20.85-4.95
			...
			l4.84,23.38c-4.07,2.53-8.57,4.29-13.48,5.27C187.65,640.5,182.74,641,177.83,641z" />
                    <path className="st0loander"
                      d="M226.06,593.19l5.27-26.33h59.61l-5.27,26.33H226.06z" />
                    <path className="st0loander" d="M302.51,639.31L325.05,526h32.65l-22.54,113.31H302.51z M346.95,510.2c-5.76,0-10.39-1.65-13.9-4.95
			...
			c4.77-2.46,8.77-6.28,12.01-11.48l24.22,15.16c-5.34,8.57-12.74,15.24-22.22,20.01C447.73,638.61,437.16,641,425.51,641z" />
                    <path className="st0loander" d="M489.33,639.31l31.17-156.28h32.86l-31.17,156.28H489.33z M522.18,616.57l7.16-40.65L590.21,526h42.76
			l-63.4,52.87l-18.32,13.48L522.18,616.57z M574.63,639.31l-29.07-47.6l22.96-25.06l44.23,72.66H574.63z" />
                    <path className="st0loander" d="M680.57,641c-11.79,0-22.01-2.11-30.65-6.32c-8.64-4.21-15.34-10.11-20.11-17.69
			...
			c5.33-1.82,9.9-4.42,13.69-7.79l13.69,21.69c-6.6,5.2-14.01,9.02-22.22,11.48C697.52,639.77,689.13,641,680.57,641z" />
                    <path className="st0loander" d="M755.97,553.8l5.06-25.27h78.56l-5.05,25.27H755.97z M798.72,641c-8.14,0-15.1-1.65-20.85-4.95
			c-5.76-3.3-9.87-8.07-12.32-14.32c-2.46-6.25-2.84-13.65-1.16-22.22l19.59-98.57h32.86l-19.59,98.36
			c-0.84,4.77-0.35,8.57,1.47,11.37c1.82,2.81,5.19,4.21,10.11,4.21c2.24,0,4.53-0.35,6.85-1.05c2.32-0.7,4.46-1.68,6.42-2.95
			l4.84,23.38c-4.07,2.53-8.57,4.29-13.48,5.27C808.55,640.5,803.64,641,798.72,641z" />
                    <path className="st0loander" d="M885.5,641c-9.97,0-19.34-1.13-28.12-3.37c-8.78-2.24-15.55-5.05-20.32-8.42l12.64-23.8
			...
			c-4.99,5.97-11.76,10.43-20.32,13.37C906.21,639.52,896.45,641,885.5,641z" />
                  ...
                  <path className="st1loander" d="M480.21,432.74c0,0,2.51,20.25,31.23,20.25l-119.19-0.51l42.36-265.66c0,0,0.72-17.23,24.05-17.59h85.8
		...
		c0,0-53.85-2.51-51.7-62.83h-63.54L419.89,433.1L480.21,432.74z" />
                  <path className="st1loander" d="M349.17,698.05L317.22,889.4c0,0-5.03,18.31,18.67,20.1h86.52c0,0-3.59-58.16,58.52-63.54
