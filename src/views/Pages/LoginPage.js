            ...
            <div className="card p-4 col-12 px-0 shadow-md">
              <div className="card-body">
                <div className="container text-center">
                  <img src={"https://api.ticketsecuador.ec/store/img/tckets-texto-azul.png"} className="mb-4 img-fluid" style={{ height: '80px' }} alt="" />
                </div>
            ...
            <div className="card px-0  shadow-md text-white py-5 d-none d-lg-block "
              style={{
                width: '100%', backgroundImage:
                  "url('https://api.ticketsecuador.ec/store/img/portada-login.png')", backgroundSize: 'cover'
              }}>
