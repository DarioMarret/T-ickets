                ...
                ProvinciasMap.length > 0 ?
                    ProvinciasMap.map((provincias,i) =>                        
                        ...
                        provincias.mapas.map((mapa,i) => {
                            ...
                            className={"border rounded-2 text-center mx-3 grid-item element-item transition justify-content-center  "+mapa.ciudad+" "+ provincias.provincia } key={"pla"+i} style={{width:"200px",height:'250px'}} >
                                    
                                    <h4 className="nombre text-capitalize " >{mapa.nombre}</h4>   
                                    <span className="text-capitalize " >{mapa.ciudad}</span> 
