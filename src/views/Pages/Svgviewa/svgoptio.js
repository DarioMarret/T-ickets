const SVGView = ({ text }) => {
    const plantilla = {
        ...
        "hotel": <svg id="Capa_1" width="90%" height="90%" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 595.28 453.54">
            ...
            <polygon id="mapas1" className="none"
