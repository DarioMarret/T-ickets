...
<svg version="1.1" xml:space="preserve" width="660" style="shape-rendering:geometricPrecision; text-rendering:geometricPrecision; image-rendering:optimizeQuality; fill-rule:evenodd; clip-rule:evenodd" viewBox="0 0 660 372">
 <defs>
  {/*<style type="text/css">
   <![CDATA[
    .fil1 {fill:#2B2A29}
 ...
 <g id="Layer_x0020_1">
  ...
  <path id="a15" d="M218 276c17,2 34,3 53,3l21 15 -19 6 17 25c-19,0 -35,-1 -53,-3l0 -6 -19 -40z" level="7" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  <path id="a16" d="M286 302c19,-9 30,-17 36,-22l31 12 -7 7 31 23c-21,2 -49,4 -74,4l-17 -23z" level="8" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  <path id="a17" d="M356 295c10,-11 18,-22 26,-34l26 5 -6 11 59 32c-23,5 -47,9 -71,12l-34 -25z" level="9" fill="#3399FF" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  <path id="a18" d="M410 270c4,-9 7,-20 9,-31l21 -2 -3 9 61 13 -23 45 -65 -35z" level="10" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  <path id="a19" d="M510 265c8,-19 16,-50 16,-79l-70 0c0,11 -3,35 -9,54l55 11 -2 12 10 2z" level="11" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  ...
  <path d="M154 106l9 -41 -1 -5c-17,4 -38,11 -56,20l18 37c10,-4 19,-8 30,-11z" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  <path d="M101 312l17 40c17,3 34,5 51,7l-7 -38c-20,-3 -41,-6 -61,-10z"/>
  <path d="M178 360l-7 -37c40,5 79,7 119,7l0 36c-38,0 -75,-2 -112,-6z"/>
  <path d="M301 330l0 36c27,0 53,-2 80,-4l-4 -36c-25,2 -51,4 -76,4z" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  ...
  <path d="M260 163l111 0c2,11 2,32 0,42l-111 0 0 -42z" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  <path d="M365 137l-18 -5 -6 -5 -46 -6 -2 -3 -41 4 8 38 110 0c-1,-7 -3,-15 -5,-22z" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
  <path d="M365 232l-18 5 -6 5 -46 6 -2 3 -41 -4 8 -38 110 0c-1,7 -3,15 -5,22z" width="200" style="" height="30%" stroke="rgb(0,255,255)" stroke-width="0" transform=" rotate(0,0,0)"/>
     <text>
         <textPath xlink:href="#a17" startOffset="50%" text-anchor="middle">We go <tspan fill="red" dy="-30">up</tspan><tspan dy="30">,</tspan> then we go down, then up again</textPath></text>
    </g>
</svg></div>
        </>
    )
