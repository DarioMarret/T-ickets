                ...
                if (encabezado == "" || descipcion == "" || fechamax == "" || imgen == "" || imgmovil == "") {
                    ...
                    try {
                        ...
                        setTimeout(async function () {
                            ...
                            if (mobil) {
                                let datas = {
                                    "evento": datos.mas["codigoEvento"] + "-" + datos.mas["lugarConcierto"] + "-" + datos.mas["nombreConcierto"] + "-" + datos.mas["estado"] + " - " + JSON.stringify(datos.mas),
                                    "encabezado": encabezado,
                                    "descripcion": descipcion,
                                    "link_img": link,
                                    "fecha_presentacion": fechamax,
                ...
                "evento": "CU1E1Q-Medio Estadio Atahualpa -ELADIO CARRION",
                    "encabezado": "ELADIO CARRION",
                        "descripcion": "Evento Bahia",
                            "link_img": "https://api.ticketsecuador.ec/store/img/cabecera.png",
