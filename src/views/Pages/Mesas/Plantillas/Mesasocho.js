        ...
        <div  style={{padding: '0.7px'}}>
              <div className="d-flex px-1">
                <div className=" "  style={{margin:'0.7',height:'15px',width:'15px',borderRadius:'5px'}}>
                  ...
                  <a href="#!" className=" bg-success"  style={{margin:'0.7',height:'15px',width:'15px',borderRadius:'5px'}}></a>
              ...
              <div className="d-flex px-1 ">
                <a className=" "  style={{margin:'0.7',height:'15px',width:'15px',borderRadius:'5px'}}>
                </a>
                <a className="bg-success"  style={{margin:'0.7',height:'15px',width:'15px',borderRadius:'5px'}}>
                </a>
