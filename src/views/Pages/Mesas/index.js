...
function MesasView({ text, status, list }) {
  ...
  const succesSilla = (e) => {
    ...
    let mesas = ["A", "B", "C"]
    let mesa = ["A"]
    let sillabloquea = ["A1", "D38", "D39", "D40","E64", "D52", "D53", "D54","E57"]
    ...
    */
    if ((envotid == '7EZFQ6') && (![...sillabloquea, ...sillasAmor, ...sillesSAmor].includes(text) && clienteInfo() == null)) {
      $.confirm({
        ...
        content: 'En esta localidad solo están habilitadas las siguientes sillas inidividuales en las localidades:<br><strong>Señorazo</strong><br><strong> A1, D38, D39, D40, D52, D53, D54, E57</strong><br>'+
