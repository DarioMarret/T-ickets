   ...
   const {success,data}=datos
    ...
    useEffect(()=>{
        ...
        mapath.pathmap.length>0?mapath.pathmap.map((elm,i)=>{
                ...
                $("svg#"+elm.path).css({"fill": ""+elm.fill+" !important" });
                $("#"+elm.path+".none").attr("fill",elm.fill)   
               // console.log(elm)
        }):''
            ...
            <Modal.Body>
               <div className='conatiner-fluid col-12'>
                   ...
                   {showMapa? <svg version="1.0" className="opciones" xmlns="http://www.w3.org/2000/svg"
                            ...
                            42 25 60 l18 32 -34 0 c-19 0 -35 5 -35 10 0 6 23 10 50 10 28 0 50 -3 50 -7z" id="2"
                             className="none"></path><path d="M4100 6800 l0 -520 125 0 125 0 0 30 0 30 65 0 65 0 0 85 0 85 150 0
                            ...
                            27z" id="6" fill="#a1218a"  className=""></path><path d="M5214 6825 c-8 -20 4 -35 27 -35 14 0 19 7 19 25 0 18 -5 25 -20 25
